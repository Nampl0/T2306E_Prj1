...
// media
  ...
  import CAC from './page/Clubs/detail/CanadianAlpineClub';
  import TheJapanMountaineeringAssociation from './page/Clubs/detail/The JapanMountaineeringAssociation';
  import IMF from './page/Clubs/detail/IndianMountaineeringFoundation';
  import ItalianAlpine from './page/Clubs/detail/ItalianAlpine';
  import PolishMountaineering from './page/Clubs/detail/PolishMountaineering';
  import SlovenianAlpine from './page/Clubs/detail/SlovenianAlpine';
  import SwissAlpine from './page/Clubs/detail/SwissAlpine';
  import UKA from './page/Clubs/detail/UKAlpine';
  ...
  return (
    <BrowserRouter basename='/'>
      ...
      <Routes>
        ...
        <Route path='/Canadian-Alpine-Club' element={<CAC/>}></Route>
        <Route path='/Indian-Alpine-Club' element={<IMF/>}></Route>
        <Route path='/Italian-Alpine-Club' element={<ItalianAlpine/>}></Route>
        ...
        <Route path='/The-Polish-Mountaineering-Association' element={<PolishMountaineering/>}></Route>
        <Route path='/Slovenian-Alpine-Club' element={<SlovenianAlpine/>}></Route>
        <Route path='/Swiss-Alpine-Club' element={<SwissAlpine/>}></Route>
        <Route path='/United-Kingdom-Alpine-Club' element={<UKA/>}></Route>
