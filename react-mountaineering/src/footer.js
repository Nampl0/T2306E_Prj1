        ...
        <footer>
            <div className='container_footer'>
                ...
                <div className='contact'>
                    ...
                    <p className='ct'> <i class="fa-solid fa-phone"></i>  </p>
                    <p className='ct'> <i class="fa-solid fa-location-dot"></i>  No.1-Dai Co Viet</p>
                    <p className='ct'> <i class="fa-solid fa-envelope"></i> example@domain.com</p>
                </div>
            </div>
            <label className='copyright'>Copyright <i class="fa-regular fa-copyright"></i> Hanoi University of Science and Technology</label>
        </footer>
    )
}
